...
\include{Exact_Discrete_Sampling}

\include{Exact_Rejection_Sampling}

\include{Putting_It_All_Together}

\include{Graphing_Prefix_Distributions}

\include{Letting_The_Base_Approach_Infinity}

\include{The_Distribution_Of_Prefix_Lengths}

\include{The_Uniformity_Of_Trailing_Digits}

\include{Some_Impossibility_Results}
